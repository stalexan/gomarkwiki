...
This page demos the Github-like style sheet that can be used by starting a Markdown file
with `#[style(github)]`. The rest of this page is just the content of the
Gomarkwiki [README.md](https://github.com/stalexan/gomarkwiki/blob/main/README.md) file.
